  ...
  return (
    <div className="absolute top-0 left-0 w-full h-[500vh] z-10 pointer-events-none">
      <div className="sticky top-0 left-0 w-full h-screen overflow-hidden flex flex-col justify-center px-8 md:px-24">
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black tracking-[0.1em] text-white uppercase mt-12 relative inline-block drop-shadow-[0_0_15px_rgba(255,255,255,0.3)] whitespace-nowrap">
